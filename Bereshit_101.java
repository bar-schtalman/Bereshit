...
public class Bereshit_101 {
	public static final double WEIGHT_EMP = 165; // kg  //Electromagnetic pulse
...
// https://davidson.weizmann.ac.il/online/askexpert/%D7%90%D7%99%D7%9A-%D7%9E%D7%98%D7%99%D7%A1%D7%99%D7%9D-%D7%97%D7%9C%D7%9C%D7%99%D7%AA-%D7%9C%D7%99%D7%A8%D7%97
	...
	public static double acc(double weight, boolean main, int seconds) {  //acc
		double t = 0;
	...
	public static void main(String[] args) {
		...
		double dist = 181*1000; // Distance  
		double ang = 60.0; // zero is vertical (as in landing)
		double alt = 13748; // 2:25:40 (as in the simulation) // https://www.youtube.com/watch?v=JJ0VfRL9AMs  //gova
		double time = 0;
		double dt = 1; // sec
		...
		while(alt>0) {
			double error = vs - dvs;
			double gas = pid.update(error, dt);
			double dd = NN + gas;
			if(dd >= 0.0 && dd <= 1) {
				NN = dd;
